...
describe('List class', () => {
  ...
  test('any', () => {
    ...
    expect(pets.any(pet => !!pet.age && pet.age > 1 && !pet.vaccinated)).toBe(
      true
    )
  })
  ...
  test('concat', () => {
    ...
    expect(
      cats
        ...
        .toArray()
    ).toEqual(['Barley', 'Boots', 'Whiskers', 'Bounder', 'Snoopy', 'Fido'])
  })
  ...
  test('insert', () => {
    ...
    expect(() => pets.insert(pets.count() + 1, newPet)).toThrowError(ERROR)
  })
  ...
  test('orderBy', () => {
    expect(new List([4, 5, 6, 3, 2, 1]).orderBy(x => x).toArray()).toEqual([
      1,
      2,
      3,
      4,
  ...
  test('thenBy', () => {
    ...
    expect(new List([4, 5, 6, 3, 2, 1]).thenBy(x => x).toArray()).toEqual([
      1,
      2,
      3,
      4,
  ...
  test('removeAll', () => {
    ...
    expect(dinosaurs.removeAll(x => x.endsWith('saurus'))).toEqual(
      lessDinosaurs
    )
  })
  ...
  test('reverse', () => {
    expect(new List([1, 2, 3, 4, 5]).reverse().toArray()).toEqual([
      5,
      4,
      3,
      2,
  ...
  test('select', () => {
    expect(new List([1, 2, 3]).select(x => x * 2).toArray()).toEqual([2, 4, 6])
  })
  ...
  test('takeWhile', () => {
    ...
    expect(fruits.takeWhile(fruit => fruit !== 'orange').toArray()).toEqual([
      'apple',
      'banana',
      'mango',
    ])
  ...
  test('where', () => {
    ...
    expect(fruits.where(fruit => fruit.length < 6).toArray()).toEqual([
      'apple',
      'mango',
      'grape',
    ])
