...
class List<T> {
     ...
     */
    firstOrDefault(predicate?: (value?: T, index?: number, list?: T[]) => boolean): T | void {
     ...
     */
    lastOrDefault(predicate?: (value?: T, index?: number, list?: T[]) => boolean): T | void {
    ...
    sequenceEqual(list: List<T>): boolean {
        return !!this._elements.reduce((x, y, z) => list._elements[z] === y ? x : false);
    }
